...
import lich.tool.encryptionAndDecryption.asymmetric.PrivateKeyTool;
...
public class TestSM2PrivateIO {
	...
	public void test() throws Exception {
		Proxy.init(InitRootCert.class.getResource("lib"));
		...
		byte [] envelopedKeyBlob=	PrivateKeyTool.toEnvelopedKeyBlobByGMPrivateKey(Base.getRootGMPrivateKey());
